     ...
     <div class="modal-dialog modal-xl" style="width: 45%">
          <div class="modal-content">
               ...
               <div class="modal-body">
                    <form action="/racks" method="post" class="" enctype="multipart/form-data">
                         @csrf
                         <div class="row">
                              <div class="">
                                   <!-- h -->
                                   <div class="">
                                        ...
                                        <input type="text" name="rack_name" value="{{ old('rack_name') }}" class="form-control flex-col" id="rack_name" required placeholder="Rack name...">
                                        @error('rack_name')
